...
latex_documents = [
    (master_doc, 'Pi-puck.tex', 'Pi-puck Documentation',
...
man_pages = [
    (master_doc, 'pi-puck', 'Pi-puck Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Pi-puck', 'Pi-puck Documentation',
     author, 'Pi-puck', 'One line description of project.',
     'Miscellaneous'),
]
